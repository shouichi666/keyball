...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [LAYER_4] = LAYOUT_universal(
        ...
        _______ ,  KC_F5    , KC_F6    , KC_F7    , KC_F8    , _______   ,                                    _______  , KC_4     , KC_5   , KC_6     , KC_DOT    , _______  ,
        _______ ,  KC_F9    , KC_F10   , KC_F11   , KC_F12   , _______   ,                                    _______  , KC_1     , KC_2   , KC_3     , KC_COMM   , _______  ,
