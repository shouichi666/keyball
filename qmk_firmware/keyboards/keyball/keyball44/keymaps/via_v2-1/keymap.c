...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [LAYER_0] = LAYOUT_universal(
        ...
        KC_LCTL  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                        KC_H     , KC_J     , KC_K     , KC_L     , QUOT_MO4 , KC_MINS,
        KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_EQL    ,
                              KC_BTN2  , MO(4)  , KC_LALT  , TD(TD_EN_LGUI_LANG) , KC_SPC ,              ENT_MO5, BS_MO5,       RCTL_T(KC_LNG2) , KC_RALT  , LT(4, KC_BTN2)
    ),
    // [LAYER_0] = LAYOUT_universal(
    ...
    [LAYER_1] = LAYOUT_universal(
        KC_GRV   , KC_QUES  , KC_7     , KC_8     , KC_9     , KC_AT    ,                                        KC_PERC     , KC_LPRN  , KC_UP     , KC_RPRN  , KC_LBRC  , _______  ,
        _______  , KC_EXLM  , KC_4     , KC_5     , KC_6     , KC_HASH  ,                                        KC_AMPR     , KC_LEFT  , KC_DOWN   , KC_RIGHT , KC_RBRC  , _______  ,
        _______  , KC_0     , KC_1     , KC_2     , KC_3     , KC_DLR   ,                                        KC_ASTR     , KC_BSLS  , _______   , _______  , _______  , _______  ,
