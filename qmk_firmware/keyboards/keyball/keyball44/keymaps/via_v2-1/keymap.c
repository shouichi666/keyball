...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    //     _______  , KC_1     , KC_2     , KC_3     , KC_4     , KC_5     ,                                        KC_7     , KC_8     , KC_UP     , KC_9     , KC_0     , _______  ,
    //     _______  , KC_LSFT  , KC_BSLS  , KC_HASH  , KC_DLR   , KC_PERC  ,                                        KC_6     , KC_LEFT  , KC_DOWN   , KC_RIGHT , _______  , _______  ,
    //     _______  , _______  , _______  , _______  , _______  , _______  ,      j                                  _______  , KC_SCLN  , _______   , _______  , _______  , _______  ,
    //                           _______  , _______  ,  _______ , _______ , _______ ,                       _______ , _______ ,       _______
    //                                  , _______  , _______
    // ),
    [LAYER_1] = LAYOUT_universal(
        _______  , KC_BSLS  , KC_7     , KC_8     , KC_9     , KC_AT    ,                                        KC_PERC     , KC_LPRN  , KC_UP     , KC_RPRN  , KC_LBRC  , KC_RBRC   ,
        _______  , KC_EXLM  , KC_4     , KC_5     , KC_6     , KC_HASH  ,                                        KC_AMPR     , KC_LEFT  , KC_DOWN   , KC_RIGHT , _______  , KC_GRV  ,
        _______  , KC_0     , KC_1     , KC_2     , KC_3     , KC_DLR   ,                                        KC_ASTR     , KC_SCLN  , _______   , _______  , _______  , _______  ,
                              _______  , _______  ,  _______ , _______ , _______ ,                       _______ , _______ ,       _______
                                     , _______  , _______
    ),
    ...
    [LAYER_4] = LAYOUT_universal(
        ...
        _______ ,  _______  , _______  , KC_LSFT  , _______  , _______   ,                                    _______  , KC_4     , KC_5   , KC_6     , KC_DOT    , _______  ,
