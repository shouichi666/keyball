...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_LAYER_0] = LAYOUT_universal(
        ...
        KC_LCTL,TD(TD_A_ESC), KC_S     , KC_D     , KC_F     , KC_G     ,                                        KC_H     , KC_J     , KC_K     , KC_L     , KC_SCLN  , KC_QUOT   ,
    ...
    [_LAYER_1] = LAYOUT_universal(
        ...
        _______  , KC_QUES  , KC_AMPR  , KC_LPRN  , KC_RPRN  , KC_PIPE   ,                                       KC_GRV   , KC_QUOT  , _______   , _______  , _______  , KC_BSLS   ,
                              _______  , _______  ,  _______ , _______ , _______ ,                    _______ , _______ ,       _______       , _______  , _______
    ),

    [_LAYER_2] = LAYOUT_universal(
        _______ ,  _______ ,  _______  , _______  , _______  , _______  ,                                        _______  , _______  , _______  , _______  , _______ , _______   ,
        _______ ,  _______  , _______  , _______  , _______  , _______  ,                                        _______  , _______  , KC_BTN1  , MO(_LAYER_3), KC_BTN2, _______ ,
        _______ ,  _______  , _______  , _______  , _______  , _______  ,                                        _______  , _______  , _______  , _______  , _______ , _______ ,
                              _______  , _______  ,  _______ , _______ , _______ ,                    _______ , _______ ,       _______       , _______  , _______
    ),

    [_LAYER_3] = LAYOUT_universal(
