...
[0] = LAYOUT_universal(
        ...
        KC_LCTL  , KC_A     , KC_S     , KC_D     , KC_F     , KC_G     ,                                        KC_H     , KC_J     , KC_K     , LT(3,KC_L), KC_SCLN , KC_MINS   ,
        KC_LSFT  , KC_Z     , KC_X     , KC_C     , KC_V     , KC_B     ,                                        KC_N     , KC_M     , KC_COMM  , KC_DOT   , KC_SLSH  , KC_EQL    ,
                              _______  , _______  , KC_LALT  , EN_LGUI , KC_SPC ,                       KC_ENT , JP_MO2 ,       RCTL_T(KC_LNG2) , KC_RALT  , GESTURE
    ),

    [1] = LAYOUT_universal(
        KC_GRV   , KC_1     , KC_2     , KC_3     , KC_4     , KC_5      ,                                       KC_6     , KC_7     , KC_8     , KC_9     , KC_0     , _______   ,
        _______  , KC_EXLM  , KC_AT    , KC_HASH  , KC_DLR   , KC_PERC   ,                                       KC_LEFT  , KC_DOWN  , KC_UP    , KC_RIGHT , KC_LBRC  , KC_QUOT   ,
        _______  , KC_QUES  , KC_AMPR  , KC_ASTR  , KC_LCBR  , KC_RCBR   ,                                       KC_EQL   , KC_MINS  , _______  , _______  , KC_RBRC  , KC_BSLS   ,
    ...
    [4] = LAYOUT_universal(
        ...
        _______ ,  KC_F9    , KC_F10   , KC_F11   , KC_F12   , LAG(KC_RIGHT),                                      _______      , KC_1      , KC_2   , KC_3     , KC_COMM   , _______  ,
                              _______  , _______  , _______  , _______ , _______ ,                       LGUI(KC_BSPC) , LALT(KC_BSPC) ,       _______      , _______  , _______
    ),
};
// clang-format on
